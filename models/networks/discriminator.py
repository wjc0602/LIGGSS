...
from models.networks.diffaug import DiffAugment
...
class MultiscaleDiscriminator(BaseNetwork):
    ...
    def downsample(self, input):
        # import ipdb
        # ipdb.set_trace()
        return nn.avg_pool2d(input, kernel_size=3, stride=2, padding=1, count_include_pad=False)
...
class NLayerDiscriminator(BaseNetwork):
    ...
    def __init__(self, opt):
        super().__init__()
        self.augment = DiffAugment(policy='color')
        self.opt = opt
