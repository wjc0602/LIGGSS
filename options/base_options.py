...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # for generator
        parser.add_argument('--netG', type=str, default='spade', help='selects model to use for netG (pix2pixhd | spade|dynast)')
        ...
        parser.add_argument('--use_vae', default=True, help='enable training with an image encoder.')
